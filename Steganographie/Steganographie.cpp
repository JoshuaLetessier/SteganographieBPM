// Steganographie.cpp : Définit le point d'entrée de l'application.
//
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   Button* test = new Button(1, hWnd, L"Test", 10, 10, 100, 50, hInstance, []() { MessageBox(NULL, L"Test", L"Test", MB_OK); });
